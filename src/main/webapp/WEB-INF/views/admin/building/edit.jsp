    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                ...
                <div class="col-xs-12">
                    <form:form modelAttribute="building" id="formEdit" cssClass="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 no-padding-right" for="rentAreaDescription">Mô tả diện tích</label>
                            <div class="col-xs-9">
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 no-padding-right" for="motoFee">Phí mô tô</label>
                            <div class="col-xs-9">
...
<script>
    ...
    function updateBuilding(data, id) {
        $.ajax({
            url: '${buildingAPI}',
            type: 'POST', // Sửa đổi thành POST
            data: JSON.stringify(data),
            dataType: 'json',
            contentType: 'application/json',
            success: function (response) {
                $('#loading_image').hide();
                window.location.href = "${buildingEditURL}-" + encodeURIComponent(id) + "?message=update_success"; // Mã hóa id
            },
            error: function () {
                showNotification('error', 'Đã xảy ra lỗi hệ thống, vui lòng thử lại sau.');
            }
